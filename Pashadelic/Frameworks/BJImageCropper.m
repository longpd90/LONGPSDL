    ...
    switch ([allTouches count])
    {
        case 1: {
            ...
            if (isPanning) {
                ...
                if (frame.size.width / imageScale < kPDMinFacebookCoverWidth && 
					self.image.size.width > kPDMinFacebookCoverWidth) {
					frame = CGRectWithWidth(frame, kPDMinFacebookCoverWidth * imageScale);
				}
                cropView.frame = frame;                
            }
        } break;
